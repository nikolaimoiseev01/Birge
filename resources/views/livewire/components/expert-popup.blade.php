        ...
        <div class="grid min-h-screen grid-cols-[48%_52%] md:grid-cols-1">
            <div class="relative flex flex-col border-r border-[#b6d8d0] md:border-r-0">
                ...
                <div class="grid h-24 grid-cols-2 border-t border-[#b6d8d0] md:fixed md:bottom-0 md:w-full md:bg-[#eef6ea]">
                    <button
                        type="button"
                        @click="change('prev')"
                        class="flex items-center justify-center border-r border-[#b6d8d0] text-5xl font-light transition hover:bg-bright-600"
                    >
                        <svg width="50" height="19" viewBox="0 0 50 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.366116 10.0888C-0.12204 9.60068 -0.12204 8.80923 0.366116 8.32107L8.32107 0.366121C8.80922 -0.122034 9.60068 -0.122034 10.0888 0.366121C10.577 0.854277 10.577 1.64573 10.0888 2.13389L3.01777 9.20496L10.0888 16.276C10.577 16.7642 10.577 17.5556 10.0888 18.0438C9.60068 18.5319 8.80922 18.5319 8.32107 18.0438L0.366116 10.0888ZM49.25 9.20496V10.455L1.25 10.455V9.20496V7.95496L49.25 7.95496V9.20496Z" fill="#1E4644"/>
                        </svg>
                    ...
                    <button
                        type="button"
                        @click="change('next')"
                        class="flex items-center justify-center text-5xl font-light transition hover:bg-bright-600"
                    >
                        <svg width="50" height="19" viewBox="0 0 50 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M48.8839 10.0888C49.372 9.60068 49.372 8.80923 48.8839 8.32107L40.9289 0.366121C40.4408 -0.122034 39.6493 -0.122034 39.1612 0.366121C38.673 0.854277 38.673 1.64573 39.1612 2.13389L46.2322 9.20496L39.1612 16.276C38.673 16.7642 38.673 17.5556 39.1612 18.0438C39.6493 18.5319 40.4408 18.5319 40.9289 18.0438L48.8839 10.0888ZM0 9.20496L0 10.455L48 10.455V9.20496V7.95496L0 7.95496L0 9.20496Z" fill="#1E4644"/>
                        </svg>
            ...
            <div class="flex items-center px-20 pb-20 md:px-4 md:py-10 bg-bright-500">
                <div
                    ...
                    x-transition:enter="transition duration-700 delay-200 ease-out"
                ...
                >
                    @if($expert)
                        <div class=" px-16 md:px-0">
                            ...
                            <p class="mb-14 max-w-[360px] text-lg leading-snug text-azure-600/60">
                                {{ $expert->description_short }}
                            </p>

                            <div class="mb-14 text-lg leading-relaxed text-azure-600">
...
<script>
    Alpine.data('expertPopup', () => ({
        ...
        async change(direction) {
            ...
            flying.style.transition = 'opacity 350ms ease-in-out';
            ...
            flying.style.transition = 'opacity 500ms ease-in-out';
            flying.style.opacity = '1';
        ...
        close() {
            ...
            flying.style.transition = 'opacity 700ms ease-in-out';
            flying.style.opacity = '0';
